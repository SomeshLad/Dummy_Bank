...
def create_user_account():
    ...
    name_label = Label(base_frame, text="Name:", bg="#7209b7",
    ...
    dob_label = Label(base_frame, text="DOB:",
                    bg="#7209b7", fg="#ced4da", font='Times 30 bold', width=12)
    ...
    Contact_label = Label(base_frame, text="Contact:", bg="#7209b7",
                        fg="#ced4da", font='Times 30 bold', width=12)
    ...
    Gender_label = Label(base_frame, text="Gender(M/F/O):", bg="#7209b7",
                        fg="#ced4da", font='Times 30 bold', width=12)
