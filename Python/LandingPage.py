...
hed = Label(root, text = "Dummy Bank Pvt.Ltd.", bg = "#4361ee",fg="#e9ecef",font="Times 50 underline bold")
...
text = """  Branch Name:                            Cidco ( 21196 ) \n  IFSC:                                          DM21196\n  Customer Care(Toll Free):       +917218288988\n  Working Hours:                        10AM - 5PM\n          Press "Escape(Esc)" Key to Exit.""",bg = "#f72585",fg="#000000",
